    ...
    >
      ...
      <div className={styles.main} data-node-id="210:551">
        <div className={styles.headlines} data-node-id="210:588" id="design-about-h">
          ...
          <p className={`${styles.hl} ${styles.hlAccent} ${styles.hlLeft}`} data-node-id="210:554">
            é percepção
          </p>
          <p className={`${styles.hl} ${styles.hlAccent} ${styles.hlRight}`} data-node-id="210:571">
            é posicionamento
          </p>
          <p className={`${styles.hl} ${styles.hlAccent} ${styles.hlLeft}`} data-node-id="210:555">
            e conversão.
          </p>
        </div>

        <div className={styles.bodyRow} data-node-id="223:449">
